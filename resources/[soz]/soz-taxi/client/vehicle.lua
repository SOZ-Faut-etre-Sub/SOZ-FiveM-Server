...
exports["qb-target"]:AddBoxZone("Véhicule taxi", vector3(890.69, -149.87, 76.89), 1, 1,
                                {name = "Véhicule taxi", heading = 0, debugPoly = false, minZ = 75.69, maxZ = 77.89}, {
    options = {
        {
            type = "client",
...
AddEventHandler("taxi:client:vehicle", function()
    ...
    vehicule_taxi = CreateVehicle(model, Config.vehicule_position.x, Config.vehicule_position.y, Config.vehicule_position.z, Config.vehicule_position.w, true,
                                  false)
