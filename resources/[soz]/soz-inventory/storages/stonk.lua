...
Config.Storages["stonk_cloakroom_1"] = {
    ...
    maxZ = 47.2,
    heading = 295,
    targetOptions = getCloakroomTargetOptions("cash-transfer", "stonk_cloakroom_1", "soz-core:client:stonk::OpenCloakroomMenu"),
}
...
Config.Storages["stonk_cloakroom_2"] = {
    ...
    maxZ = 47.2,
    heading = 295,
    targetOptions = getCloakroomTargetOptions("cash-transfer", "stonk_cloakroom_2", "soz-core:client:stonk::OpenCloakroomMenu"),
}
