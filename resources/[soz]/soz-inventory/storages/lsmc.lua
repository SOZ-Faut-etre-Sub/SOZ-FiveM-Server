...
Config.Storages["lsmc_male_cloakroom"] = {
    ...
    maxZ = 34.01,
    heading = 320,
    targetOptions = getCloakroomTargetOptions("lsmc", "lsmc_male_cloakroom", "soz-core:client:lsmc::OpenCloakroomMenu"),
}
...
Config.Storages["lsmc_female_cloakroom"] = {
    ...
    maxZ = 33.91,
    heading = 320,
    targetOptions = getCloakroomTargetOptions("lsmc", "lsmc_female_cloakroom", "soz-core:client:lsmc::OpenCloakroomMenu"),
}
