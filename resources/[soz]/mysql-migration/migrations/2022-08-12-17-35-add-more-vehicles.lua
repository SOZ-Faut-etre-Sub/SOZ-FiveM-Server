table.insert(migrations, {
    ...
    queries = {
        ...
        [[ UPDATE vehicles SET dealership_id = NULL WHERE model = 'jb700'; ]],
        [[ UPDATE vehicles SET dealership_id = NULL WHERE model = 'jester2'; ]],
        [[ UPDATE vehicles SET dealership_id = NULL WHERE model = 'kuruma2'; ]],
        [[ UPDATE vehicles SET dealership_id = NULL WHERE model = 'paragonfbi'; ]],
        [[ UPDATE vehicles SET dealership_id = NULL WHERE model = 'stromberg'; ]],
