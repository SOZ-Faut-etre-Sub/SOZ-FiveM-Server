                ...
                while tickPosition < compass.position.x + compass.width do
                    if (tickDegree % 90.0) == 0 then
                        ...
                        if compass.cardinal.tickShow then
                            DrawRect(
                                tickPosition, compass.position.y, compass.cardinal.tickSize.w,
                        ...
                        drawText(
                            degreesToIntercardinalDirection(tickDegree), tickPosition,
                    ...
                    elseif (tickDegree % 45.0) == 0 and compass.intercardinal.show then
                        ...
                        if compass.intercardinal.tickShow then
                            DrawRect(
                                tickPosition, compass.position.y, compass.intercardinal.tickSize.w,
                        ...
                        -- Draw tick
                        DrawRect(
                            tickPosition, compass.position.y, compass.tickSize.w, compass.tickSize.h,
