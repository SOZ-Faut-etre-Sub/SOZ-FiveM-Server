        ...
        [GetHashKey("mp_f_freemode_01")] = {
            ...
            ["Tenue hazmat"] = {
                Components = {
                    ...
                    [6] = {Drawable = 25, Texture = 0, Palette = 0},
                    [7] = {Drawable = 0, Texture = 0, Palette = 0},
                    [8] = {Drawable = 43, Texture = 0, Palette = 0},
                    [9] = {Drawable = 0, Texture = 0, Palette = 0},
                    [10] = {Drawable = 0, Texture = 0, Palette = 0},
                    [11] = {Drawable = 61, Texture = 0, Palette = 0},
                },
                Props = {[0] = {Clear = true}},
            },
            ["Tenue Hiver"] = {
                Components = {
                    ...
                    [8] = {Drawable = 217, Texture = 11, Palette = 0},
                    [9] = {Drawable = 0, Texture = 0, Palette = 0},
                    [10] = {Drawable = 0, Texture = 0, Palette = 0},
                    [11] = {Drawable = 475, Texture = 0, Palette = 0},
                },
                Props = {},
            },
        },
