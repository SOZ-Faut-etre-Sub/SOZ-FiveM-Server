...
Labels = {
    ...
    HairMale = {
        ...
        {value = 79, label = "Fondu bouclé court"},
        {value = 80, label = "Frange rideau"},
    },
    HairFemale = {
        ...
        {value = 83, label = "Coupe césar"},
        {value = 84, label = "Baby Braids"},
        {value = 85, label = "Couronne de tresses"},
        {value = 86, label = "Tresses longues"},
        {value = 87, label = "Triple chignon"},
        {value = 88, label = "Coupe au carré"},
        {value = 89, label = "Double chignon"},
        {value = 90, label = "Queue de cheval"},
        {value = 91, label = "Tresses doubles mi-long"},
    },
    BeardMale = {
