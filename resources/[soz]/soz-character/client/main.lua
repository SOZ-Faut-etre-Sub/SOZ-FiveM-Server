...
Labels = {
    ...
    AddBodyBlemishes = { { value = -1, label = GetLabelText("NONE") }, { value = 0, label = "0" },
        { value = 1,  label = "1" } },
    HairMale = {
    ...
    HairFemale = {
        ...
        { value = 84, label = "Couronne de tresses" },
        { value = 85, label = "Tresses longues" },
        { value = 86, label = "Triple chignon" },
        { value = 87, label = "Coupe au carré" },
        { value = 88, label = "Double chignon" },
        { value = 89, label = "Queue de cheval" },
        { value = 90, label = "Tresses doubles mi-long" },
    },
    BeardMale = {
