...
Labels = {
    ...
    HairMale = {
        ...
        {value = 75, label = "Afro, dégradé"},
        {value = 76, label = "Chignon"},
        {value = 77, label = "Deux blocs"},
        {value = 78, label = "Nuque longue ébouriffée"},
    },
    HairFemale = {
        ...
        {value = 25, label = "Cornrows"},
        {value = 26, label = "Cornrows en bandes"},
        {value = 27, label = "Cornrows en losange"},
        {value = 28, label = "Nattes arrières"},
        {value = 29, label = "Tresses en coquillage"},
        {value = 30, label = "Tresse tentaculaire"},
        {value = 31, label = "Coupe rétro"},
        {value = 32, label = "Lissé vers l'arrière"},
        {value = 33, label = "Viking arrière"},
        {value = 34, label = "Viking sur le côté"},
        {value = 35, label = "Coupe iroquoise"},
        {value = 76, label = "Chignon"},
        {value = 77, label = "Mèche rebelle"},
        {value = 78, label = "Coupe Banane"},
        {value = 79, label = "Afro, dégradé"},
        {value = 80, label = "Semi-court, bouclé"},
        {value = 81, label = "Frange"},
        {value = 82, label = "Nuque longue ébouriffée"},
