...
function StartUnzoomSkyCam()
    ...
    UnzoomSkyCam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -421.0049, 1155.414, 324.8574 + 500, -85.00, 0.00,
    260.00, 100.00, false, 0)
    SetCamActive(UnzoomSkyCam, true)
    SetFocusPosAndVel(-421.0049, 1155.414, 324.8574 + 10, 50, 0.0, 0.0)
    ShakeCam(UnzoomSkyCam, "HAND_SHAKE", 0.15)
    SetEntityVisible(PlayerPedId(), false)
    RenderScriptCams(true, false, 3000, 1, 1)

    SetFocusPosAndVel(-265.51, -811.01, 31.85 + 175, 0.0, 0.0, 0.0)
...
function StartZoomSkyCam()
    ZoomSkyCam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -400.00, 1700.00, 31.85 + 3000, -85.00, 0.00, 260.00,
    100.00, false, 0)
