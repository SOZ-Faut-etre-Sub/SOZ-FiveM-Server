...
Zonesentreprise = {
    ...
    ["bennys_luxury"] = BoxZone:Create(vector3(-182.63, -1317.06, 31.3), 14.2, 11.2, {
    ...
    ["baun_unicorn"] = BoxZone:Create(vector3(147.54, -1280.56, 29.09), 17, 22, {
        name = "baun_unicorn_z",
        heading = 299,
        minZ = 28.09,
        maxZ = 31.09,
    ...
    ["ffs"] = BoxZone:Create(vector3(747.36, -963.78, 24.83), 23.8, 15.4, {
        name = "ffs_z",
        heading = 0,
        minZ = 23.83,
        maxZ = 27.83,
...
PlacesEntreprise = {
    ...
    ["bennys_luxury1"] = BoxZone:Create(vector3(-182.37, -1316.29, 31.3), 8.0, 3.8,
                                        {
        name = "bennys_luxury1",
        heading = 0,
        minZ = 30.3,
        maxZ = 33.3,
        data = {indexGarage = "bennys_luxury"},
    }),
    ...
    ["ffs1"] = BoxZone:Create(vector3(745.0, -966.3, 24.87), 10.0, 5.2, {
        name = "ffs1",
        heading = 270,
        minZ = 23.87,
        maxZ = 27.87,
    ...
    ["ffs2"] = BoxZone:Create(vector3(744.95, -960.56, 24.86), 10.0, 5.2, {
        name = "ffs2",
        heading = 270,
        minZ = 23.86,
        maxZ = 27.86,
