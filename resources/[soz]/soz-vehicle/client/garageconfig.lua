...
PlacesEntreprise = {
    ...
    ["lsmc1"] = BoxZone:Create(vector3(331.2, -1468.28, 31.73), 4.6, 8.0,
                               {name = "lsmc1", heading = 50, minZ = 28.33, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
    ["lsmc2"] = BoxZone:Create(vector3(327.82, -1471.29, 29.21), 4.4, 7.6,
                               {name = "lsmc2", heading = 50, minZ = 28.21, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
    ["lsmc3"] = BoxZone:Create(vector3(324.93, -1474.73, 30.89), 4.25, 7.4,
                               {name = "lsmc3", heading = 50, minZ = 28.21, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
