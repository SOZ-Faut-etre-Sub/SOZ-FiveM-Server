...
Zonespublic = {
    ...
    ["airport_air"] = BoxZone:Create(vector3(-1144.29, -2855.37, 13.95), 108.0, 49.0, {
        name = "airport_air",
        heading = 60,
        minZ = 12.95,
        maxZ = 17.95,
...
Zonesentreprise = {
    ...
    ["lsmc"] = BoxZone:Create(vector3(405.69, -1431.89, 29.45), 33.8, 25.2, {
    ...
    ["taxi"] = BoxZone:Create(vector3(908.34, -174.12, 74.23), 17, 37.2, {
        name = "taxi_z",
        heading = 55,
        minZ = 72.23,
        maxZ = 77.63,
    }),
    ["taxi_air"] = BoxZone:Create(vector3(879.5, -151.68, 78.34), 0.6, 0.6, {
        name="taxi_air",
        heading=1,
        minZ = 77.23,
        maxZ = 78.63,
...
PlacesEntreprise = {
    ...
    ["bennys_air_slot1"] = BoxZone:Create(vector3(-145.89, -1272.41, 49.57), 14.8, 14.4,
                                          {
        name = "bennys_air_slot1",
        heading = 0,
        minZ = 48.57,
        maxZ = 54.57,
        data = {indexGarage = "bennys_air"},
    }),
    ...
    ["lsmc2"] = BoxZone:Create(vector3(408.44, -1435.93, 29.44), 9.2, 3.4,
                               {name = "lsmc2", heading = 30, minZ = 28.21, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
    ["lsmc3"] = BoxZone:Create(vector3(412.23, -1433.73, 29.44), 9.2, 3.4,
                               {name = "lsmc3", heading = 30, minZ = 28.21, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
    ["lsmc4"] = BoxZone:Create(vector3(415.73, -1431.74, 29.44), 9.2, 3.4,
                               {name = "lsmc4", heading = 30, minZ = 28.21, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
    ["lsmc5"] = BoxZone:Create(vector3(399.06, -1429.48, 29.44), 9.2, 3.4,
                               {name = "lsmc5", heading = 50, minZ = 28.21, maxZ = 32.53, data = {indexGarage = "lsmc"}}),
    ["lsmc6"] = BoxZone:Create(vector3(401.59, -1426.42, 29.44), 9.2, 3.4,
    ...
    ["taxi_air1"] = PolyZone:Create({
        vector2(865.94793701172, -149.26512145996),
        vector2(871.0678100586, -152.277053833),
        vector2(876.42706298828, -150.70715332032),
        vector2(879.65826416016, -145.84951782226),
        vector2(878.26361083984, -140.17663574218),
        vector2(873.24615478516, -137.16622924804),
        vector2(867.54754638672, -138.55975341796),
        vector2(864.47033691406, -143.62902832032)
      }, {
        name="taxi_air",
