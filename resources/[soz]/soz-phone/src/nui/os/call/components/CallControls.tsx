...
import { EndCallIcon } from "../../../../../../soz-core/src/nui/components/Phone/assets/endCall";
...
export const CallControls: FunctionComponent = () => {
    ...
    return (
        <div className="absolute bottom-40 inset-x-0 flex justify-around">
            {callInProgress ? (
                <Fragment>
                    <EndCallIcon className="h-20 w-20 text-white p-4 bg-red-500 rounded-full cursor-pointer" onClick={handleEndCall} />
                    <MicrophoneIcon
                ...
                <Fragment>
                    <EndCallIcon className="h-20 w-20 text-white p-4 bg-red-500 rounded-full cursor-pointer" onClick={handleRejectCall} />
