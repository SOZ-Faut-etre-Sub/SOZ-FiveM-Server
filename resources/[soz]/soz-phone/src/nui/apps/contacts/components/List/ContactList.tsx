                            ...
                            >
                                {filteredContacts[letter].map(contact => (
                                    ...
                                    >
                                        ...
                                        >
                                            <Menu.Items className="absolute z-30 right-0 w-56 mt-2 origin-top-right bg-black bg-opacity-70 divide-y divide-gray-600 divide-opacity-50 rounded-md shadow-lg focus:outline-none">
                                                <Menu.Item>
                                                    <Button
