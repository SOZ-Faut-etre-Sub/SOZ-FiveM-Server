...
import { MarketplaceEvents, MarketplaceListing, MarketplaceListingBase } from '@typings/marketplace';
...
const defaultData: MarketplaceListing[] = [
    {
        ...
        description: 'skldfsdEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE',
...
export const listingState = atom<MarketplaceListing[]>({
    ...
    default: selector({
        ...
        get: async () => {
            try {
                const resp = await fetchNui<ServerPromiseResp<MarketplaceListing[]>>(MarketplaceEvents.FETCH_LISTING);
                return resp.data;
            } catch (e) {
                if (isEnvBrowser()) {
                    return defaultData;
