...
export const DarkwebImageModal = ({ isOpen, conversationId, onClose, image }: IProps) => {
    ...
    const sendImageMessage = useCallback(
        m => {
            sendMessage({ conversationId: conversationId, message: m });
            onClose();
        },
        [sendMessage, conversationId, onClose]
    );
