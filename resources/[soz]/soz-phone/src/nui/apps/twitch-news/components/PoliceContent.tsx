...
export const PoliceContent: FunctionComponent<TwitchNewsMessage> = ({ type, message, reason }: TwitchNewsMessage) => {
    ...
    return (
        <>
            Les forces de l'ordre sont à la recherche de <strong>{message + (reason != '' ? ' (' + reason + ')' : '')}</strong>.
            <br />
