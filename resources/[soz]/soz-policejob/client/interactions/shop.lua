    ...
    local shopOptions = {
        {
            ...
            canInteract = function()
                return SozJobCore.Functions.HasPermission("lspd", SozJobCore.JobPermission.ManageGrade) or SozJobCore.Functions.HasPermission("bcso", SozJobCore.JobPermission.ManageGrade)
            end,
        },
    }
