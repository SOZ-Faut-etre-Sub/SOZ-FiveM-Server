...
PoliceJob.Functions.Menu.GenerateMenu = function(job, cb)
    ...
    if MenuV.CurrentMenu == nil or MenuV.CurrentMenu.UUID ~= menu.UUID or MenuV.CurrentMenu.Subtitle ~= menu.Subtitle or MenuV.CurrentMenu.Items ~= menu.Items or not menu.IsOpen then
