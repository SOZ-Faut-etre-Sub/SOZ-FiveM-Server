...
CreateThread(function()
    exports["qb-target"]:AddGlobalPlayer({
        options = {
            {label = "Facturer", color = "news", icon = "c:jobs/facture.png", event = "jobs:client:news:InvoicePlayer", job = "news"},
        },
        distance = 1.5,
    })
    ...
    exports["qb-target"]:AddTargetModel(removalObject, {
        options = {
            {label = "Récupérer", color = "news", icon = "c:jobs/recuperer.png", event = "job:client:RemoveObject", collect = true},
        },
        distance = 2.5,
    })
    ...
    exports["qb-target"]:AddBoxZone("jobs:news:farm", vector3(-564.09, -917.33, 33.34), 1, 1, {
        ...
        options = {
            {label = "Imprimer", color = "news", icon = "c:news/imprimer.png", event = "jobs:client:news:farmNewspaper", job = "news"},
        },
        distance = 2.5,
    })
...
RegisterNetEvent("jobs:client:news:SellNewspaper", function()
    ...
    exports["qb-target"]:AddBoxZone("jobs:news:sell", delivery, 1.0, 1.0,
        ...
        options = {
            {label = "Livrer", color = "news", icon = "c:news/livrer.png", event = "jobs:client:news:newspaperSold", job = "news"},
        },
        distance = 2.5,
    })
