        ...
        zones = {
            {
                ...
                length = 6.8,
                width = 0.2,
                options = {name = "baun:harvest:liquor", heading = 0, minZ = 113.38, maxZ = 115.58, debugPoly = true},
            },
        },
    },
    {
        ...
        zones = {
            {
                ...
                length = 2.6,
                width = 0.1,
                options = {name = "baun:harvest:flavor:1", heading = 0, minZ = 29.46, maxZ = 31.66, debugPoly = true},
            },
        },
    },
    {
...
BaunConfig.CraftZones = {
    {
        ...
        length = 0.2,
        width = 0.2,
        options = {name = "baun:unicorn:craft:1", heading = 25, minZ = 29.27, maxZ = 29.67, debugPoly = false},
    },
    {
        center = vector3(-1392.21, -606.3, 30.32),
        length = 0.2,
        width = 0.2,
        options = {name = "baun:bahama:craft:1", heading = 0, minZ = 30.37, maxZ = 30.77, debugPoly = true},
    },
    {
        center = vector3(-1377.96, -628.86, 30.82),
        length = 0.2,
        width = 0.2,
        options = {name = "baun:bahama:craft:2", heading = 0, minZ = 30.82, maxZ = 31.22, debugPoly = true},
    },
}
