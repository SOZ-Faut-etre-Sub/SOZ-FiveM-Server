...
function DisplayZone(zone)
    ...
    p1 = vector2((math.cos(angle) * (p1.x - zone.x) - math.sin(angle) * (p1.y - zone.y) + zone.x),
                 (math.sin(angle) * (p1.x - zone.x) + math.cos(angle) * (p1.y - zone.y) + zone.y))
    p2 = vector2((math.cos(angle) * (p2.x - zone.x) - math.sin(angle) * (p2.y - zone.y) + zone.x),
                 (math.sin(angle) * (p2.x - zone.x) + math.cos(angle) * (p2.y - zone.y) + zone.y))
    p3 = vector2((math.cos(angle) * (p3.x - zone.x) - math.sin(angle) * (p3.y - zone.y) + zone.x),
                 (math.sin(angle) * (p3.x - zone.x) + math.cos(angle) * (p3.y - zone.y) + zone.y))
    p4 = vector2((math.cos(angle) * (p4.x - zone.x) - math.sin(angle) * (p4.y - zone.y) + zone.x),
                 (math.sin(angle) * (p4.x - zone.x) + math.cos(angle) * (p4.y - zone.y) + zone.y))
