export enum NuiEvent {
    ...
    GangSmugglingEditZoneSelectPropToCreate = 'soz-core:client:business:smuggling:edit-zone:select-create',
    GangSmugglingEditZoneChoosePropToCreate = 'soz-core:client:business:smuggling:edit-zone:choose-create',
    GangSmugglingEditZoneRequestDeleteProp = 'soz-core:client:business:smuggling:edit-zone:prop-delete',
    GangSmugglingEditZoneSelectPlacedProp = 'soz-core:client:business:smuggling:edit-zone:select-edit',
    GangSmugglingEditZoneChoosePlacedPropToEdit = 'soz-core:client:business:smuggling:edit-zone:choose-edit',
    GangSmugglingEditZoneToggleMouseSelection = 'soz-core:client:business:smuggling:edit-zone:mouse',
    GangSmugglingEditZoneTogglePipette = 'soz-core:client:business:smuggling:edit-zone:pipette',
    GangSmugglingEditZoneSelectPropToRemove = 'soz-core:client:business:smuggling:edit-zone:select-remove',
