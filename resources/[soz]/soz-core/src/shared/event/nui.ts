export enum NuiEvent {
    ...
    PlayerMenuHudSetShowDateTime = 'soz-core:nui:player:menu:hud-set-show-date-time',
    PlayerMenuHudSetShowWeather = 'soz-core:nui:player:menu:hud-set-show-weather',
    PlayerMenuHudSetShowStreetName = 'soz-core:nui:player:menu:hud-set-show-street-name',
    PlayerMenuHudSetShowCompass = 'soz-core:nui:player:menu:hud-set-show-compass',
