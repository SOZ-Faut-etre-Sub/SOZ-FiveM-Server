export enum NuiEvent {
	...
	PhoneAppTcgSetWallpaper = 'soz-core:nui:phone:app-tcg-set-wallpaper',
    PhoneAppTcgRemoveWallpaper = 'soz-core:nui:phone:app-tcg-remove-wallpaper',
    PhoneAppTcgGetWallpaper = 'soz-core:nui:phone:app-tcg-get-wallpaper',
    PhoneAppTcgGetContacts = 'soz-core:nui:phone:app-tcg-get-contacts',
    PhoneAppTcgSendContactRequest = 'soz-core:nui:phone:app-tcg-send-contact-request',
    PhoneAppTcgAcceptContact = 'soz-core:nui:phone:app-tcg-accept-contact',
    PhoneAppTcgRejectContact = 'soz-core:nui:phone:app-tcg-reject-contact',
    PhoneAppTcgRemoveContact = 'soz-core:nui:phone:app-tcg-remove-contact',
    PhoneAppTcgGetContactCollection = 'soz-core:nui:phone:app-tcg-get-contact-collection',
    PhoneAppTcgRequestTrade = 'soz-core:nui:phone:app-tcg-request-trade',
	PhoneAppTcgGetProfile = 'soz-core:nui:phone:app-tcg-get-profile',
    PhoneAppTcgSetUsername = 'soz-core:nui:phone:app-tcg-set-username',
