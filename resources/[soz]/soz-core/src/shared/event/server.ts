export enum ServerEvent {
    ...
    GANG_SMUGGLING_BLACK_HARVEST_TAKE = 'soz-core:server:gang:smuggling:harvest-take',
    GANG_SMUGGLING_BLACK_HARVEST_SIGNAL = 'soz-core:server:gang:smuggling:harvest-signal',
