...
export const Halloween2023Scenario1: Story = {
    ...
    dialog: {
        ...
        part2: {
            ...
            text: [
                'Mmmh, bonjour bonjour.. J’en déduis que vous devez être notre nouvel enquêteur ?',
                'Mmmmh, très bien très bien.',
        ...
        part3: {
            ...
            text: [
                ...
                'Je vais pouvoir effectuer de plus profondes analyse afin de mieux observer ce phénomène.',
        ...
        part4: {
            ...
            text: [
                ...
                'Vous voulez une chopping pendant que vous me racontez votre histoire ?',
                'Il y a plein sur le navires !',
                'Mmh, je comprends mieux...',
                'Cela ne me dérange pas de vous aider, mais ce cargo ne peut pas partir sans son capitaine !',
        ...
        part5: {
            ...
            text: [
                ...
                'Ecoutez, je suis un homme simple,',
        ...
        part6: {
            ...
            text: [
                ...
                'Mmmmh, mmmmmh. MMMMH. DELICIEUX ! Prévenez Joël, je le remplace !',
            ],
        },
        part7: {
            audio: 'audio/halloween-2023/scenario1/part7.mp3',
            text: [
                'Il a accepté ? Merveilleux ! Oh, petit conseil, rendez-vous au cristal un peu plus tard, voir demain !...',
            ],
        },
    },
    zones: [
