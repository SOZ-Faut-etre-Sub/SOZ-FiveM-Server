...
export const BossShop: (ShopConfig & { job: JobType })[] = [
    ...
    // MIRROR PARK
    {
        ...
        products: [
            ...
            { id: 'armor_lifejacket', type: 'item', metadata: { label: 'LSPD', type: 'lspd' }, price: 150 },
            { id: 'armor_securejacket', type: 'item', metadata: { label: 'LSPD', type: 'lspd' }, price: 150 },
            { id: 'armor_marinejacket', type: 'item', metadata: { label: 'LSPD', type: 'lspd' }, price: 150 },
            { id: 'armor_detentionjacket', type: 'item', metadata: { label: 'LSPD', type: 'lspd' }, price: 150 },
        ],
    },
    {
        name: 'bcso',
        ...
        products: [
            ...
            { id: 'armor_lifejacket', type: 'item', metadata: { label: 'BCSO', type: 'bcso' }, price: 150 },
            { id: 'armor_securejacket', type: 'item', metadata: { label: 'BCSO', type: 'bcso' }, price: 150 },
            { id: 'armor_marinejacket', type: 'item', metadata: { label: 'BCSO', type: 'bcso' }, price: 150 },
            { id: 'armor_detentionjacket', type: 'item', metadata: { label: 'BCSO', type: 'bcso' }, price: 150 },
        ],
    },
    // MIRROR PARK
    {
...
export const BossShopWhatIf: (ShopConfig & { job: JobType })[] = [
    {
        ...
        products: [
            ...
            { id: 'weapon_stungun', type: 'weapon', price: 45 },
            { id: 'mobile_radar', type: 'item', price: 40 },
            { id: 'paper', type: 'item', price: 1 },
            { id: 'weapon_pistol_mk2', type: 'weapon', price: 100 },
            { id: 'weapon_nightstick', type: 'weapon', price: 10 },
            { id: 'weapon_flashlight', type: 'weapon', price: 10 },
            { id: 'weapon_revolver_mk2', type: 'weapon', price: 100 },
            { id: 'ammo_01', type: 'item', price: 3 },
            { id: 'ammo_02', type: 'item', price: 3 },
            { id: 'handcuffs', type: 'item', price: 2 },
            { id: 'handcuffs_key', type: 'item', price: 2 },
            { id: 'spike', type: 'item', price: 5 },
            { id: 'speed_speed_sign', type: 'item', price: 5 },
            { id: 'cone', type: 'item', price: 5 },
            { id: 'police_pliers', type: 'item', price: 5 },
            { id: 'armor_plate', type: 'item', price: 30 },
            { id: 'police_barrier', type: 'item', price: 5 },
        ],
    },
];
