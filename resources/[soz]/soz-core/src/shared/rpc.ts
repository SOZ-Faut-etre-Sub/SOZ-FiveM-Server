export enum RpcServerEvent {
	...
	PHONE_APP_TCG_SET_WALLPAPER = 'soz-core:server:phone:app:tcg:set-wallpaper',
    PHONE_APP_TCG_REMOVE_WALLPAPER = 'soz-core:server:phone:app:tcg:remove-wallpaper',
    PHONE_APP_TCG_GET_WALLPAPER = 'soz-core:server:phone:app:tcg:get-wallpaper',
    PHONE_APP_TCG_GET_CONTACTS = 'soz-core:server:phone:app:tcg:get-contacts',
    PHONE_APP_TCG_SEND_CONTACT_REQUEST = 'soz-core:server:phone:app:tcg:send-contact-request',
    PHONE_APP_TCG_ACCEPT_CONTACT = 'soz-core:server:phone:app:tcg:accept-contact',
    PHONE_APP_TCG_REJECT_CONTACT = 'soz-core:server:phone:app:tcg:reject-contact',
    PHONE_APP_TCG_REMOVE_CONTACT = 'soz-core:server:phone:app:tcg:remove-contact',
    PHONE_APP_TCG_GET_CONTACT_COLLECTION = 'soz-core:server:phone:app:tcg:get-contact-collection',
    PHONE_APP_TCG_REQUEST_TRADE = 'soz-core:server:phone:app:tcg:request-trade',
	PHONE_APP_TCG_GET_PROFILE = 'soz-core:server:phone:app:tcg:get-profile',
    PHONE_APP_TCG_SET_USERNAME = 'soz-core:server:phone:app:tcg:set-username',
