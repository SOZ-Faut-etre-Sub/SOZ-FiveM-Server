...
export const Walks: WalkConfigList = [
    {
        ...
        name: 'Classiques',
        items: [
            { type: 'walk', name: 'Démarche par défaut H', walk: 'move_m@multiplayer' },
            { type: 'walk', name: 'Démarche par défaut F', walk: 'move_f@multiplayer' },
            { type: 'walk', name: 'Marche lente', walk: 'move_m@casual@a' },
            { type: 'walk', name: 'Marche', walk: 'move_m@casual@b' },
            { type: 'walk', name: 'Marche 2', walk: 'move_m@casual@e' },
            { type: 'walk', name: 'Marche 3', walk: 'move_characters@dave_n' },
            { type: 'walk', name: 'Marche 4', walk: 'move_characters@floyd' },
            { type: 'walk', name: 'Marche 5', walk: 'move_p_m_one' },
            { type: 'walk', name: 'Marche 6', walk: 'move_dreyfuss' },
            { type: 'walk', name: 'Marche rapide', walk: 'move_m@casual@f' },
            { type: 'walk', name: 'Marche très rapide', walk: 'move_m@casual@c' },
            { type: 'walk', name: 'Chubby F', walk: 'move_f@chubby@a' },
            { type: 'walk', name: 'Chubby F 2', walk: 'move_f@fat@a_no_add' },
            { type: 'walk', name: 'Large', walk: 'move_m@fat@a' },
            { type: 'walk', name: 'Large 2', walk: 'move_f@fat@a' },
            { type: 'walk', name: 'Large 3', walk: 'move_chubby' },
            { type: 'walk', name: 'Féminine', walk: 'move_f@femme@' },
            { type: 'walk', name: 'Féminine 2', walk: 'move_m@femme@' },
            { type: 'walk', name: 'Féminine 3', walk: 'move_f@chichi' },
            { type: 'walk', name: 'Féminine 4', walk: 'move_f@heels@c' },
            { type: 'walk', name: 'Féminine 5', walk: 'move_casey' },
        ],
    },
    {
        type: 'category',
        name: 'Alcool',
        items: [
            { type: 'walk', name: 'Bourré', walk: 'move_m@drunk@a' },
            { type: 'walk', name: 'Bourré 2', walk: 'move_m@drunk@slightlydrunk' },
            { type: 'walk', name: 'Bourré 3', walk: 'move_m@drunk@moderatedrunk' },
            { type: 'walk', name: 'Bourré 4', walk: 'move_m@buzzed' },
            { type: 'walk', name: 'Bourré 5', walk: 'move_m@drunk@verydrunk' },
            { type: 'walk', name: 'Bourré 6', walk: 'move_m@drunk@moderatedrunk_head_up' },
        ],
    },
    {
        type: 'category',
    ...
    },
    {
        ...
        items: [
            ...
            { type: 'walk', name: 'Confiant', walk: 'move_f@tough_guy@' },
            { type: 'walk', name: 'Frimeur', walk: 'move_m@shadyped@a' },
            { type: 'walk', name: 'Gangster', walk: 'move_m@gangster@generic' },
            { type: 'walk', name: 'Gangster 2', walk: 'move_m@gangster@var_e' },
            { type: 'walk', name: 'Gangster 3', walk: 'move_m@gangster@ng' },
            { type: 'walk', name: 'Gangster 4', walk: 'move_m@gangster@var_i' },
            { type: 'walk', name: 'Gangster 5', walk: 'anim_group_move_ballistic' },
            { type: 'walk', name: 'Gangster 6', walk: 'move_m@fire' },
            { type: 'walk', name: 'Gangster 7', walk: 'move_gangster' },
            { type: 'walk', name: 'Gangster 8', walk: 'move_m@gangster@var_a' },
            { type: 'walk', name: 'Gangster 9', walk: 'move_m@gangster@var_b' },
            { type: 'walk', name: 'Gangster 10', walk: 'move_m@gangster@var_c' },
            { type: 'walk', name: 'Gangster 11', walk: 'move_m@gangster@var_d' },
            { type: 'walk', name: 'Gangster 12', walk: 'move_m@gangster@var_k' },
            { type: 'walk', name: 'Gangster 13', walk: 'move_m@gangster@ng' },
            { type: 'walk', name: 'Musclé', walk: 'Musclé' },            
            { type: 'walk', name: 'Combatif', walk: 'Combatif' },
        ],
    },
    {
        type: 'category',
        ...
        items: [
            ...
            { type: 'walk', name: 'Flic', walk: 'move_m@business@a' },
            { type: 'walk', name: 'Flic 2', walk: 'move_m@business@b' },
            { type: 'walk', name: 'Flic 3', walk: 'move_m@business@c' },
            { type: 'walk', name: 'Feu', walk: 'move_characters@franklin@fire' },
            { type: 'walk', name: 'Feu 2', walk: 'move_characters@michael@fire' },
        ],
    },
    {
        type: 'category',
        name: 'Émotions',
        items: [
            { type: 'walk', name: 'Détendue', walk: 'move_m@confident' },
            ...
            { type: 'walk', name: 'Déterminé 2', walk: 'move_m@brave@a' },
            { type: 'walk', name: 'Enjoué', walk: 'anim@move_m@grooving@' },
            { type: 'walk', name: 'Enjouée', walk: 'anim@move_f@grooving@' },
            ...
            { type: 'walk', name: 'Triste 2', walk: 'move_m@sad@b' },
            { type: 'walk', name: 'Énervé', walk: 'move_p_m_zero_janitor' },
            { type: 'walk', name: 'Pressé', walk: 'move_f@hurry@a' },
            { type: 'walk', name: 'Déprimé', walk: 'move_m@depressed@a' },
            { type: 'walk', name: 'Déprimé 2', walk: 'move_m@depressed@b' },
            { type: 'walk', name: 'Déprimé 5', walk: 'move_f@depressed@a' },
            { type: 'walk', name: 'Déprimé 7', walk: 'move_f@depressed@c' },
        ],
    },
    {
        type: 'category',
        name: 'Spéciales',
        items: [
            { type: 'walk', name: 'Blessé', walk: 'move_m@injured' },
            ...
            { type: 'walk', name: 'Fuite', walk: 'move_f@flee@c' },
            { type: 'walk', name: 'Fuite 2', walk: 'move_m@flee@a' },
            { type: 'walk', name: 'Fuite 3', walk: 'move_m@flee@b' },
            { type: 'walk', name: 'Fuite 4', walk: 'move_m@flee@c' },
    ...
    },
    {
        ...
        items: [
            ...
            { type: 'walk', name: 'Randonnée', walk: 'move_m@hiking' },
            { type: 'walk', name: 'Randonnée 2', walk: 'move_f@hiking' },
        ],
    },
];
