...
export const CallButtonDynamicIsland = () => {
    ...
    const styles = useSpring({
        ...
        to: {
            left: !callModalOpen && currentCall && currentCall?.is_accepted ? 290 : 200,
            opacity: !callModalOpen && currentCall && currentCall?.is_accepted ? 1 : 0,
        },
    });
