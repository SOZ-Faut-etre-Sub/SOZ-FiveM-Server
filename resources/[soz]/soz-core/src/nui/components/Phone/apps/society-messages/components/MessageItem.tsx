            ...
            actions={[
                {
                    ...
                    icon: BookmarkIcon,
                    onClick: () => fetchNui(NuiEvent.PhoneAppSocietyUpdateMessage, { id: message.id, isDone: true }),
                ...
                },
                {
                    ...
                    color: 'bg-orange-500 text-white',
                    icon: BookmarkIcon,
                    onClick: () => fetchNui(NuiEvent.PhoneAppSocietyUpdateMessage, { id: message.id, isTaken: true }),
