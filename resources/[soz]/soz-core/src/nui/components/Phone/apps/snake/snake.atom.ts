...
export const useGameSnakeLeaderboard = () => useAtomValue(leaderboardAtom);

export const useAppSnakeStateHandlers = () => {
    const setLeaderboard = useSetAtom(leaderboardAtom);

    useNuiEvent('phone', 'AppSnakeSetLeaderboard', setLeaderboard);
