...
export const BankApp: FunctionComponent = () => {
    ...
    return (
        <div className="absolute h-full w-full flex justify-center items-center font-sans z-30 bg-black/50">
            <div ref={refOutside} className="h-full w-full max-w-[1536px] mx-auto my-auto py-12">
                <Transition
                    className="flex gap-4 bg-gradient-to-br from-[#1c2128] via-[#1c2826] to-[#1c2128] text-white/80 h-full w-full rounded-2xl p-4 overflow-hidden"
                    show={showApp}
