...
Config.Locations["ponsonbys"] = {
    ["ponsonbys1"] = vector4(-707.84, -152.87, 37.42, 125.7),
    ["ponsonbys2"] = vector4(-164.61, -301.41, 39.73, 256.5),
    ["ponsonbys3"] = vector4(-1449.84, -239.20, 49.81, 50.99),
}

Config.Locations["suburban"] = {
    ["suburban1"] = vector4(127.42, -223.54, 54.56, 71.99),
    ["suburban3"] = vector4(-1194.53, -767.30, 17.32, 216.9),
    ["suburban4"] = vector4(-3168.95, 1043.83, 20.86, 70.68),
}

Config.Locations["binco"] = {
    ["binco1"] = vector4(427.32, -806.08, 29.49, 87.53),
    ["binco2"] = vector4(-823.21, -1072.28, 11.33, 208.86),
    ["binco3"] = vector4(73.65, -1392.97, 29.38, 268.02),
    ["binco4"] = vector4(6.12, 6511.31, 31.88, 47.79),
