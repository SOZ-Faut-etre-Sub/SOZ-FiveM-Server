...
Config.Locations["ponsonbys"] = {
    ["ponsonbys1"] = vector4(-708.9, -151.38, 37.42, 125.7),
    ["ponsonbys2"] = vector4(-165.28, -303.18, 39.73, 256.5),
    ["ponsonbys3"] = vector4(-1448.54, -238.02, 49.81, 50.99),
}

Config.Locations["suburban"] = {
    ["suburban1"] = vector4(127.21, -224.29, 54.56, 71.99),
    ["suburban3"] = vector4(-1193.98, -766.84, 17.32, 216.9),
    ["suburban4"] = vector4(-3169.27, 1043.23, 20.86, 70.68),
}

Config.Locations["binco"] = {
    ["binco1"] = vector4(427.23, -807.14, 29.49, 87.53),
    ["binco2"] = vector4(-822.51, -1071.78, 11.33, 208.86),
    ["binco3"] = vector4(73.8, -1392.08, 29.38, 268.02),
    ["binco4"] = vector4(5.33, 6510.79, 31.88, 47.79),
    ["binco5"] = vector4(1695.52, 4822.3, 42.06, 114.62),
    ["binco6"] = vector4(1197.49, 2711.92, 38.22, 179.31),
    ["binco7"] = vector4(-1101.93, 2712.25, 19.11, 229.23),
}
