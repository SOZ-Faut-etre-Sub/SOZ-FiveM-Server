Config.Products["supermarket"] = {
    ...
    [10] = {name = "instantazouille", price = 25, amount = 2000},
    [11] = {name = "mini_zigmac", price = 25, amount = 2000},
    [12] = {name = "zait_fruite", price = 25, amount = 2000},
    [13] = {name = "zanta_glace_energetique", price = 25, amount = 2000},
}
