local Elevators = {
    ...
    ["lsmc:0"] = {
        ...
        buttons = vector2(362.97, -1427.64),
        size = vector2(0.40, 0.20),
        heading = 227.56,
        z = {min = 32.91, max = 33.31},
        upTo = {"lsmc:1", "lsmc:2"},
        downTo = nil,
        spawnPoint = vector4(364.94, -1426.28, 32.51, 228.85),
    },
    ["lsmc:1"] = {
        name = "LSMC:Elevator1",
        label = "1er Etage",
        buttons = vector2(362.62, -1427.32),
        size = vector2(0.20, 0.80),
        heading = 318.33,
        z = {min = 38.44, max = 38.79},
        upTo = "lsmc:2",
        downTo = "lsmc:0",
        spawnPoint = vector4(365.18, -1426.50, 37.98, 228.85),
    },
    ["lsmc:2"] = {
        name = "LSMC:Elevator2",
        label = "Toit",
        buttons = vector2(337.45, -1432.94),
        heading = 320,
        z = {min = 46.85, max = 47.25},
        upTo = nil,
        downTo = {"lsmc:1", "lsmc:0"},
    ...
    ["admin:-1"] = {
        ...
        job = {fbi = 0, lspd = 0, bcso = 0, sasp = 0, gouv = 0},
    },
    --- MTP
    ["mtp:0"] = {
        name = "MTP:Elevator0",
