...
QBShared.Items = {
    ...
    ['processed_psilocybine'] = {
        ...
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "La Psilocybine est un puissant hallucinogène fabriqué à partir de champignon. Elle est réputée pour ses effets euphoriques et sa capacité à provoquer une hyperactivité.",
    },
    ...
    ['processed_zeed'] = {
        ...
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "La Zeed est un puissant perturbateurs fabriqué à partir de feuilles naturelles. Elle est réputée pour ses effets de bien-être et sa capacité de provoquer de violent bad-trip.",
    },
    ['zeed_joint'] = {
        ['name'] = 'zeed_joint',
        ['label'] = 'Joint de Zeed',
    ...
    ['processed_pandoxine'] = {
        ...
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = "La Pandoxine est un puissant analgésique fabriqué à partir de chair d'animal. Elle est utilisée pour soulager la douleur extrême, mais son utilisation prolongée peut entraîner une dépendance sévère.",
    },
    ['tablet_pandoxine'] = {
    ...
    ['krakezeed_patch'] = {
        ['name'] = 'krakezeed_patch',
        ['label'] = 'Patch de Krakezeed',
        ['weight'] = 400,
        ['type'] = 'drug',
        ['unique'] = false,
        ['useable'] = true,
    ...
    ['rubis_des_mers'] = {
        ...
        ['illustrator'] = '.Dave Creach',
        ['fishing_area'] = {'morning'},
        ['fishing_weather'] =  { 'FOGGY', 'SMOG', 'RAIN'},
        ['fishing_period'] = {'south_sea','canals'},
        ['fishman_status'] = 'clean',   -- drug, alcool, clean
        ['min_weight'] = 1200,          -- poids minimal en grammes
        ['max_weight'] = 2500,         -- poids maxmimal en grammes
        ['min_length'] = 25,           -- taille minimale en cm
