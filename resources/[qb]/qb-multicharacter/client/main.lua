...
print ("multicharcloseNUIdefault")
...
print ("multicharcloseNUI")
    DeleteEntity(charPed)
    SetNuiFocus(false, false)
end)

RegisterNetEvent('qb-multicharacter:client:chooseChar', function()
print ("multicharchooseChar")
    SetNuiFocus(false, false)
    DoScreenFadeOut(10)
    Wait(1000)
...
print ("multicharselectCharacter")
